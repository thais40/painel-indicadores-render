...
# ================= Credenciais Jira ========================
# Suporta st.secrets (Streamlit) e variáveis de ambiente (Render)
JIRA_URL = "https://tiendanube.atlassian.net"
try:
    _email = st.secrets.get("EMAIL", "")
    _token = st.secrets.get("TOKEN", "")
except Exception:
    _email = ""
    _token = ""
EMAIL = os.environ.get("EMAIL", "") or _email
TOKEN = os.environ.get("TOKEN", "") or _token
if not EMAIL or not TOKEN:
    st.error("⚠️ Configure EMAIL e TOKEN em st.secrets (Streamlit) ou variáveis de ambiente (Render) para acessar o Jira.")
    st.stop()
